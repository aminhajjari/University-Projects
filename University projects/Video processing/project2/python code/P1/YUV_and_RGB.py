...
# Save the combined YUV frame
cv2.imwrite("combined_yuv_frame.jpg", yuv_frame)


# Save the converted RGB frame
cv2.imwrite("converted_rgb_frame.jpg", rgb_frame)
