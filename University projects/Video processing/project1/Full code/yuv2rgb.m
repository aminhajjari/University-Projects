...
%Converts YUV frame into RGB format
%rgb=yuv2rgb(yuv)
%Version: 2.02, Date: 2006/05/25, author: Nikola Sprljan
%
%Input:
...
%
%Note:
% YUV subsampling format is supposed to be 4:2:0, so the bilinear
% interpolation is employed in the YUV space. There are two conversions
% available, one as specified by Microsoft, other as specified by ITU-R
% recommendation, the one not used is commented out.
%
%Example:
% rgb = yuv2rgb(Y,U,V);
